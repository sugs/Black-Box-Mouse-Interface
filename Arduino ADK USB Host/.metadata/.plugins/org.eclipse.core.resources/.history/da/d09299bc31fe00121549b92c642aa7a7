...
C_SRCS += \
../Sensor_Parser_Implementation/aJSON_API/utility/stringbuffer.c 

OBJS += \
./Sensor_Parser_Implementation/aJSON_API/utility/stringbuffer.o 

C_DEPS += \
./Sensor_Parser_Implementation/aJSON_API/utility/stringbuffer.d 


# Each subdirectory must supply rules for building sources it contributes
Sensor_Parser_Implementation/aJSON_API/utility/%.o: ../Sensor_Parser_Implementation/aJSON_API/utility/%.c
	@echo 'Building file: $<'
